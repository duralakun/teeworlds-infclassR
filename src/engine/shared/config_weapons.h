...
MACRO_CONFIG_INT(InfSoldierBombDmgRadius, inf_soldier_bomb_dmg_radius, 180, 0, 1000, CFGFLAG_SERVER, "explosion radius of soldier bombs")
...
MACRO_CONFIG_INT(InfBarrierDamage, inf_barrier_damage, 0, 0, 100, CFGFLAG_SERVER, "0 kills zombies, bigger zero deals damage")
...
MACRO_CONFIG_INT(InfBioLaserDamage, inf_bio_laser_damage, 10, 0, 100, CFGFLAG_SERVER, "Damage in hearts")
MACRO_CONFIG_INT(InfBioLaserEnergy, inf_bio_laser_energy, 400, 0, 1000, CFGFLAG_SERVER, "Energy of biologist laser")
MACRO_CONFIG_INT(InfSniperLaserBaseDmg, inf_sniper_laser_base_dmg, 10, 0, 30, CFGFLAG_SERVER, "Damage in hearts")
MACRO_CONFIG_INT(InfSniperLockedLaserDmg, inf_sniper_locked_laser_dmg, 30, 0, 100, CFGFLAG_SERVER, "Damage in hearts")
...
MACRO_CONFIG_INT(InfShotgunFireDelay, inf_shotgun_fire_delay, 250, 100, 2000, CFGFLAG_SERVER, "Fire delay in milli-seconds")
...
MACRO_CONFIG_INT(InfTurretSelfDestructDmg, inf_turret_self_destruct_dmg, 15, 0, 100, CFGFLAG_SERVER, "damage taken by zombie if turret is destroyed")
